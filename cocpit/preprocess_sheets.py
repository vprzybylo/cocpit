...
def main(open_dir, save_dir, write_single_images):
    ...
    for filename in os.listdir(open_dir):
        ...
        for i,c in enumerate(cnts):
            ...
            if write_single_images:
                #print(save_dir+filename[:-4]+'_'+str(i)+'.png')
                cv2.imwrite(save_dir+filename[:-4]+'_'+str(i)+'.png', cropped)
