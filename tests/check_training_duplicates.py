    ...
    if folder == 'aggs':
        ...
        for file in os.listdir(open_dir+folder):
            if file in os.listdir('cpi_data/campaigns/2000_ARM/single_imgs'):
                ...
                count_2000_ARM += 1
            if file in os.listdir('cpi_data/campaigns/2002_CRYSTAL-FACE-NASA/single_imgs'):
                count_NASA += 1
            if file in os.listdir('cpi_data/campaigns/2002_CRYSTAL-FACE-UND/single_imgs'):
        ...
        print(count_2000_ARM,count_NASA,count_UND,count_AIRS,count_Midcix,count_ICEL,count_OLYMPEX)
        total_count = count_2000_ARM+count_NASA+count_UND+count_AIRS+count_Midcix+count_ICEL+count_OLYMPEX
        print('total', total_count)
        
        f.write('ARM, NASA, UND, AIRS, Midcix, ICEL, Olympex \n')
        f.write("%s,%s,%s,%s,%s,%s,%s\n" % (count_2000_ARM,count_NASA,count_UND,count_AIRS,count_Midcix,count_ICEL,count_OLYMPEX))
        f.write(total_count)
