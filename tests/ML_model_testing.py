...
#                print('LABEL COUNT = ', label_counts)
            ...
            if phase == 'train':
                ...
                with open('save_acc_loss_train_e50_bs128.csv', 'a', newline='') as file:
                    writer = csv.writer(file)
                    writer.writerow([model_name, epoch, np.float(epoch_acc_train), epoch_loss_train])
                ...
                with open('save_acc_loss_val_e50_bs128.csv', 'a', newline='') as file:
                    writer = csv.writer(file)
                    writer.writerow([model_name, epoch, np.float(epoch_acc_val), epoch_loss_val])
    ...
    with open('save_model_timing.csv', 'a', newline='') as file:
        writer = csv.writer(file)
