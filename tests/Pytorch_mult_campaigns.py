...
# experiment.log_code('/data/data/tests/Pytorch_mult_campaigns.py')
...
def train_model(model_name, savename, dataloaders_dict, epochs, batch_size, num_classes, is_inception, feature_extract=False):
...
#                 experiment.log_metric('epoch_loss_train', epoch_loss_train)
                ...
                with open('/data/data/saved_models/save_train_acc_loss_'+'e'+str(epochs)+'_bs'+str(batch_size)+'.csv', 'w', newline='') as file:
...
#                 experiment.log_metric('epoch_loss_val', epoch_loss_val)
                ...
                with open('/data/data/saved_models/save_val_acc_loss_'+'e'+str(epochs)+'_bs'+str(batch_size)+'.csv', 'w', newline='') as file:
                    writer = csv.writer(file)
    ...
    #with open('../saved_models/save_model_timing.csv', 'w', newline='') as file:
    #    writer = csv.writer(file)
...
def main():
    ...
    torch.save(valloader, '/data/data/saved_models/val_loader_%s_e%d_bs%d.pth' %(model_name, epochs, batch_size))
